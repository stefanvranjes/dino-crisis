...
public class ST2 : LevelManager
{
    ...
    private void FUN_3980(CriPlayer param1)
    {
        ...
        param1.DAT_112 = 0;
        param1.DAT_40.z = 0;
        param1.FUN_609C8(DAT_7D00[param1.DAT_1DB], 0, 0);
    ...
    private void FUN_3AA0(CriPlayer param1)
    {
        ...
        if (!bVar2)
        {
            ...
            if (bVar1)
            {
                ...
                param1.PTR_120 = null;
                param1.DAT_120 = 0;
                param1.FUN_609C8(DAT_7D00[param1.DAT_1DB + 2], 0, 10);
                oVar4.DAT_152 = 1;
        ...
        else
        {
            param1.DAT_40.z = 0;
            param1.DAT_3E++;
            param1.FUN_609C8(DAT_7D00[param1.DAT_1DB + 4], 0, 0);
            uVar3 = param1.DAT_1C0;
        }
    ...
    private void FUN_4300(CriPlayer param1)
    {
        ...
        param1.DAT_3F = 0;
        param1.DAT_3E = 1;
        param1.FUN_609C8(DAT_7D00[param1.DAT_1DB + 12], 0, 0);
        FUN_2DA0(param1, 0xaf, 0x1300);
        param1.DAT_40.z = 100;
