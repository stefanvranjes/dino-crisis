...
public class CriPlayer : CriSkinned
{
        ...
        switch (DAT_3E)
        {
            ...
            case 1:
                ...
                if (bVar2 == 0)
                {
                    if (DAT_1F8 != 0)
                    {
                        FUN_609C8((TodScriptableObject)SceneManager.instance.database.playerCore.objects[0x8018fdc8], 0, 6);
                        bVar3 = 0x3c;
                        DAT_1F4 = bVar3;
                        DAT_3E++;
                        break;
    ...
    private void FUN_53BC8()
    {
        ...
        if (REFS_2 != null)
            FUN_609C8(REFS_2[DAT_21C + 2], 1, 5);
        else
    ...
    {
        if (REFS_2 != null)
            FUN_609C8(REFS_2[DAT_21C + 1], 0, 8);
        else
    ...
    private void FUN_541F0()
    {
        ...
        {
            if (REFS_2 != null)
                FUN_609C8(REFS_2[DAT_21C + 5], 1, 5);
            else
