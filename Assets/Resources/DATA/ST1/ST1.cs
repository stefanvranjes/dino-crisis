...
public class ST1 : LevelManager
{
    ...
    private byte[] DAT_18 = new byte[] { 0, 3, 2, 1, 4, 4, 2, 1, 0, 3, 3, 2, 1, 0, 4, 1, 0, 3, 4, 2, 0, 1, 2, 3, 4, 0, 3, 2, 1, 4, 4, 2 };
    ...
    private void FUN_1360(CriParticle param1)
    {
        ...
        iVar7 = 0;
        oVar10 = null;
        System.Array.Copy(local_48, DAT_14, 4);
        System.Array.Copy(local_38, DAT_18, 20);
        System.Array.Copy(local_78, SceneManager.instance.staticObjects, 5);
