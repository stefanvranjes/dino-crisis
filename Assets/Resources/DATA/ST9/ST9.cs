...
public class ST9 : LevelManager
{
    ...
    private void FUN_4170(CriPlayer param1)
    {
        ...
        FUN_B15C(param1);
        oVar6 = SceneManager.instance.DAT_27C[10];
    ...
    private void FUN_4B10(CriPlayer param1)
    {
        ...
        oVar5 = SceneManager.instance.DAT_27C[10];
        FUN_B15C(param1);
    ...
    private void FUN_56D0(CriPlayer param1)
    {
        ...
        else
        {
            ...
            if (uVar1 == 36 && param1.DAT_1C3 != 0 && 0xc00 < (ushort)(param1.FUN_64804(SceneManager.instance.DAT_27C[10].screen) - 0x200) && param1.UDAT_1DC < 3500)
            {
                param1.DAT_1C3 = 0;
                param1.DAT_3E++;
            }
    ...
    private void FUN_5A8C(CriPlayer param1)
    {
        ...
        param1.DAT_40 = new Vector3Int(0, 0, 0);
        param1.FUN_656EC();
        pbVar1 = (CriPlayer)SceneManager.instance.DAT_27C[10];
    ...
    private void FUN_6CA4(CriPlayer param1)
    {
        ...
        iVar3 = (int)GameManager.FUN_64650();
        uVar4 = (uint)iVar3 % 5;
        sVar2 = (short)param1.FUN_64804(SceneManager.instance.DAT_27C[10].screen);
    ...
    private void FUN_B15C(CriPlayer param1)
    {
        ...
        if ((GameManager.instance.DAT_922C & 2) == 0 && (param1.DAT_128 & 0x3ff) != 0)
        {
            ...
            oVar3 = (CriPlayer)SceneManager.instance.DAT_27C[uVar2 & 0xff];
    ...
    private void FUN_C0E4(CriPlayer param1)
    {
        ...
        Utilities.RotMatrix(ref SceneManager.instance.DAT_27C[10].vr, ref auStack_38);
        ...
        else
        {
            if (1 < iVar6)
            {
                ...
                else
                {
                    ...
                    if (iVar6 != 3)
                    {
                        param1.PTR_68[0] = SceneManager.instance.DAT_7CDC[5];
                        goto LAB_CF98;
                    }
                }
    ...
    private void FUN_D2A8(CriParticle param1)
    {
        ...
        do
        {
            oVar5 = SceneManager.instance.DAT_7CDC[iVar7];
    ...
    private void FUN_D4B4(CriParticle param1)
    {
        ...
        do
        {
            local_48[iVar6] = SceneManager.instance.DAT_7CDC[iVar6];
            iVar6++;
        } while (iVar6 < 5);
        ...
        if (bVar4)
        {
            ...
            if ((oVar6.flags & 2) != 0)
            {
                ...
                do
                {
                    ...
                    oVar5.tags = 18;
                    oVar5.flags |= 2;
                    oVar5.screen.x = DAT_16D20[param1.SDAT_78 * 3];
                    oVar5.screen.y = DAT_16D20[param1.SDAT_78 * 3 + 1];
                    oVar5.screen.z = DAT_16D20[param1.SDAT_78 * 3 + 2];
                    oVar5.DAT_4C = null;
                } while (iVar4 < 2);
            }
        }
    ...
    private void FUN_DC04(CriParticle param1)
    {
        ...
        else
        {
            if (1 < bVar1)
            {
                ...
                param1.flags |= 2;
                param1.screen.x = DAT_16D20[param1.SDAT_78 + 16] - 85;
            ...
            param1.flags |= 2;
            param1.screen.x = DAT_16D20[param1.SDAT_78 + 16];
        }
